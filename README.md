...
**Для жюри:** запуск — раздел 3; три примера проверки — раздел 5; [схема решения](docs/architecture.md), [демо на 5 минут](docs/demo.md), [текст выступления](docs/pitch.md), [разбор произвольного GID](docs/jury-cheatsheet.md).
